...
- synthetic GeoJSON, workflow JSON, deterministic benchmark geometries, point-in-polygon join
  fixtures, teaching failure cases, and runtime-generated GeoPackage fixtures;
