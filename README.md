...
isolated Server boundary. Canonical result + manifest evidence is shown after execution, together
with a local projection-free SVG coordinate preview of the current result. It still does not provide
file upload, persistence, a basemap, or projection-aware Web GIS.
