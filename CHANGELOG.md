...
- source and clean installed-wheel CI now cover Python 3.10 through 3.14, with cross-platform
  reproduction moved to Python 3.14 while Python 3.10 remains covered until its upstream support
  window closes.
